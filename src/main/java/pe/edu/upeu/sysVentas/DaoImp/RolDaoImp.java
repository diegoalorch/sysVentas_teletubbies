...
private JdbcTemplate jdbcTemplate;
	...
	public Rol read(int id) {
		...
		//Optional rol = jdbcTemplate.queryForList(SQL,ElementType)
		return null; //jdbcTemplate.queryForObject(SQL, new Object[] {id},new BeanPropertyRowMapper<Rol>(Rol.class));
	}
